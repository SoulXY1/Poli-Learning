...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <form class="contacto" action="Backend/validar.php" method="post">
            <fieldset>
                <legend>Información Personal</legend>

                <label for="codigoStudent">Código:</label>
                <input type="text" id="codigo" name="codigoStudent" placeholder="Ingrese su codigo de estudiante">

                <label for="passwordStudent">Contraseña:</label>
                <input type="password" id="contra" name="passwordStudent" placeholder="Ingrese su contraseña">
            </fieldset>
