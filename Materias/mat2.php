...
<body>
    ...
    <section class="imagen-materia" style="background-image: url(../img/mantenimientoBlack.jpg);">  
            <div class="contenedor contenido-materia-head">
                <h2>Mantenimiento de equipos computacionales</h2> 
    ...
    <main class="seccion contenedor">
        ...
        <div class="modulo">
            <div class="tareas-section">
                ...
                <p class="tarea"><a href="tarea.php">Tarea 1: </a></p>
                <p class="tarea"><a href="tarea.php">Tarea 2: </a></p>
                <p class="tarea"><a href="tarea.php">Tarea 3: </a></p>
                <p class="tarea"><a href="tarea.php">Tarea 4: </a></p>
                <p class="tarea"><a href="tarea.php">Tarea 5: </a></p>
            </div>
        </div>
